...
/*编写一个类ResizingArrayQueueOfStrings,使用定长数组实现队列的抽象,然后扩展实例,
 * 使用调整数组的方法突破大小的限制  
...
public class ResizingArrayQueueOfStrings<Item> implements Iterable<Item>{
	...
	public static void main(String[] args) {
		ResizingArrayQueueOfStrings<String> re=new ResizingArrayQueueOfStrings<String>();
		re.enqueue("君名");
		...
		re.enqueue("名");
		re.enqueue("字");
		System.out.println(re.peek());
		re.enqueue("：");
		re.enqueue("TaoYuHang");
		re.enqueue("TaoYuHang");
		re.enqueue("TaoYuHang");
		re.enqueue("TaoYuHang");
		System.out.println(re.dequeue());
